 ...
 * The loaded data is then sorted and deduplicated before being returned.
 ...
 * @property cityMapper The mapper to convert from data transfer objects ([CityDto]) to domain models ([CityModel]).
...
class CityRepositoryImpl @Inject constructor(
    ...
    override suspend fun loadAll(): ResponseState<List<CityModel>> = withContext(dispatcher.io) {
        runCatching {
